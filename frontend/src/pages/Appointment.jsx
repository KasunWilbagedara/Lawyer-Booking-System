        ...
        <div>
            ...
            <div className='flex flex-col sm:flex-row gap-4'>
                ...
                <div className='flex-1 border border-[#ADADAD] rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>
                    ...
                    {/* ----- law Info : name, degree, experience ----- */}

                    <p className='flex items-center gap-2 text-3xl font-medium text-gray-700'>{lawInfo.name} <img className='w-5' src={assets.verified_icon} alt="" /></p>
                    ...
                    <div>
                        ...
                        <p className='text-sm text-gray-600 max-w-[700px] mt-1'>{lawInfo.about}</p>
                    </div>

                    <p className='text-gray-600 font-medium mt-4'>Appointment fee: <span className='text-gray-800'>{currencySymbol}{lawInfo.fees}</span> </p>
                </div>
            </div>
            ...
            {/* Listing Releated lawyers */}
            <RelatedLawyers speciality={lawInfo.speciality} lawId={lawId} />
        </div>
    ) : null
}
